        ...
        this.model = [
            {
            ...
            },
             {
                label: 'Product',
                items: [
                    { label: 'Add', icon: 'pi pi-fw pi-id-card', routerLink: ['/product'] },
                    { label: 'List', icon: 'pi pi-fw pi-list', routerLink: ['/product-list'] },
            ]
            },
            {
                label: 'Supplier/Customer',
                items: [
                    { label: 'Add', icon: 'pi pi-fw pi-id-card', routerLink: ['/supplier'] },
                    { label: 'List', icon: 'pi pi-fw pi-list', routerLink: ['/supplier-list'] },
            ]
            },
            
            {
                label: 'Purchase',
                items: [
                    { label: 'Add', icon: 'pi pi-fw pi-id-card', routerLink: ['/purchase'] },
                    { label: 'List', icon: 'pi pi-fw pi-list', routerLink: ['/purchase-list'] },
            ]
            },
            {
                label: 'Sales',
